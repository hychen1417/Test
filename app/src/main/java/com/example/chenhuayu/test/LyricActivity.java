...
import com.example.chenhuayu.test.lrcview.ILrcView;
import com.example.chenhuayu.test.lrcview.LrcDataBuilder;
import com.example.chenhuayu.test.lrcview.LrcRow;
import com.example.chenhuayu.test.lrcview.LrcView;
...
public class LyricActivity extends Activity {
	...
	protected void onPause(){
		super.onPause();
		mPlayer.pause();
		resumeTime = mPlayer.getCurrentPosition();


	}
	protected void onResume(){
		super.onResume();
		mLrcView.seekLrcToTime(resumeTime);
		mPlayer.seekTo((int) resumeTime);
		mPlayer.start();
	}
